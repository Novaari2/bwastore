            ...
            <div class="col-lg-4">
              ...
              <form class="mt-3" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group" v-if="is_store_open">
                  ...
                  <input type="text" v-model="store_name" id="store_name" name="store_name" class="form-control @error('store_name') is-invalid @enderror" required autocomplete autofocus>
                  @error('store_name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
